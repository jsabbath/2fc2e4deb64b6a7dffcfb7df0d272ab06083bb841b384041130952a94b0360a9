...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-11-2015 a las 05:02:18
...
CREATE TABLE IF NOT EXISTS `tbarea` (
  ...
  `vcnombreArea` varchar(50) NOT NULL,
  PRIMARY KEY (`cid`)
...
INSERT INTO `tbarea` (`cid`, `vcnombreArea`) VALUES
(1, 'RR.HH.'),
(2, 'Almacen'),
(3, 'Logistica'),
(4, 'Marketing'),
...
CREATE TABLE IF NOT EXISTS `tbcargo` (
  ...
  `vcnombreCargo` varchar(60) NOT NULL,
  PRIMARY KEY (`cid`),
  KEY `cidarea` (`cidarea`)
...
INSERT INTO `tbcargo` (`cid`, `cidarea`, `vcnombreCargo`) VALUES
(1, '1', 'Cargo 1'),
(2, '4', 'Cargo 2'),
(3, '4', 'Cargo 3'),
(4, '4', 'Cargo 4');
...
(1, '1', '1', '1', 'A', '2015-11-01', '2015-11-03', ''),
(2, '2', '2', '1', 'M', '2014-08-06', '2015-11-04', '');
...
(1, 'Alan dotoniel', 'peralta', 'Capcha', '98782738', '1'),
(2, 'Pedro andres alfonzo', 'Pica', 'Piedra', '15641484', '2');
...
(1, '1012', 'solo dos meses sin goze vacacional'),
(2, '728', 'sin goze de paga'),
(3, 'qeqwqw', 'qdsda'),
(4, '1201', 'Contrato de Ventas'),
(5, '1212', 'Extremado trabajo'),
(6, '1213', 'sin goze de pago');
